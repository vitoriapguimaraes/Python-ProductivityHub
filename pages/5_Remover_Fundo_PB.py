...
st.info(
    "💡 **Dica:** Para obter os melhores resultados, utilize imagens com fundo predominantemente branco ou cinza bem claro."
)
        ...
        for idx, up_file in enumerate(uploaded_files):
            with st.spinner(f"Processando {up_file.name}..."):
                try:
                    ...
                    processed_images.append({"name": out_name, "data": img_bytes})
